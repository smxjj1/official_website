...
export function useHomeSeo() {
  ...
  useSeo({
    ...
    description: 'Discover Huangyan Oya Plastic Factory\'s collection of safe, high-quality baby products. Feeding bottles, water cups, tableware, bath essentials, and accessories for your little one.',
    canonicalPath: '/',
  })
...
export function useProductsPageSeo() {
  useSeo({
    ...
    description: 'Explore Huangyan Oya Plastic Factory\'s complete range of baby products. Feeding bottles, water cups, tableware, bath products, and accessories designed for your baby\'s safety and comfort.',
